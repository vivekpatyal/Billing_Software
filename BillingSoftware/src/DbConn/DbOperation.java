...
public class DbOperation 
{
    ...
    public static int updateEmployeeDetails(RegisterModel reg)
    {
        int i=0;
        try
        {
    ...
    public static int deleteEmployeeDetails(String email)
    {
        int i=0;
        try
        {
    ...
    public static boolean insertItemsDetails(FileInputStream fis,String... str)
    {
        boolean status=false;
        try
        {
    ...
    public static boolean checkOldPassword(String oldpassword,String email)
    {
        boolean status=false;
        try
        {
    ...
    public static boolean updatePassword(String new_password,String email)
    {
        boolean status=false;
        try
        {
   ...
   public static boolean customerBillingDetails(String customer_phoneno,String items,String datee,String timee,String emp_email)
    {
        boolean status=false;
        ...
        try
            {
                ...
                ps.setString(1, customer_phoneno);
   ...
   public static ResultSet getCustomerShoppingDetails(String phoneno)
   {
       ResultSet rs=null;
       try
       {
           Connection con=DbConnection.getConnection();
           PreparedStatement ps=con.prepareStatement("select * from customer_shopping_details where customer_phoneno=?");
           ps.setString(1, phoneno);
            rs=ps.executeQuery();
       }
       catch(Exception e)
